...
const InstructionsModal = () => {
    ...
    const handleUpdateInstructions = async () => {
        ...
        try {
            ...
            localStorage.setItem("aether_user_instructions", text);
            setInitialText(text);
            setIsOpen(false);
            toast.success("Changes saved! (Demo mode - stored locally)");
        } catch (error) {
    ...
    useEffect(() => {
        ...
        const saved = localStorage.getItem("aether_user_instructions") || "";
        setText(saved);
