...
const CourseOvaContainer = ({ user, course, courses, messages }: CourseOvaContainerProps) => {
    ...
    const totalDuration = course.lectures.reduce((sum, l) => sum + (l.duration || 0), 0);
                                    ...
                                    >
                                        <div className="flex items-start gap-3">
                                            <div className="flex items-center gap-2 shrink-0 mt-0.5">
                                                <Circle className={cn(
                                                    "h-3 w-3",
                                                    isCompleted ? "text-primary fill-current" : "text-muted-foreground"
                                                )} />
                                                ...
                                                {course.instructor && (
                                                    <div className="flex items-start gap-4 p-4 rounded-lg bg-muted/30">
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <p className="text-xs text-muted-foreground mt-1">
                                                                {course.instructor.name} is an experienced instructor with expertise in this field. 
                                                                They bring practical knowledge and insights to help you master the subject.
                                                            </p>
                                                        </div>
                                                    </div>
                                                )}
                        ...
                        <div>
                            ...
                            <div className="flex items-center justify-between text-sm mb-2">
                                <span className="text-muted-foreground">
                                    {Math.floor((course.progress || 0) / 100 * course.lectures.length)}/{course.lectures.length} COMPLETED
                                </span>
                            </div>
